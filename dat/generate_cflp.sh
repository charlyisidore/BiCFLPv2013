...
# THIS SCRIPT GENERATES THE SSCFLP INSTANCES FROM ELENA FERNANDEZ WESBITE
...
echo "THIS SCRIPT GENERATES THE SSCFLP INSTANCES FROM ELENA FERNANDEZ WESBITE"
delete_txt_files
rm -rf  cflp_instances
mkdir cflp_instances
cd cflp_instances
