...
public:
  ...
  /*!
   *	\brief Getter for the capacity of this \c Facility.
  ...
  /*!
   *	\brief Setter for the capacity of this \c Facility.
   *	\param[in] val : A double which represents the value of the capacity of this \c Facility.
   */
...
private:
  ...
  /*!< Double which represents the value of the capacity of this \c Facility */
  double capacity_;
};
