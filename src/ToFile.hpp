...
public:
  ...
  /*!
   *	\brief \e Static method to save non dominated solutions into a file.
   *
   *	\param[in] lsol : A set of efficient solution modeled because of \c EfficientSolution class.
   */
  static void saveParetoFrontier(EfficientSolution & efficient_population, Data &data);
  static void savePopulation(vector<Solution* > population, Data &data, string ext);
  static void gnuplot_interactive(std::vector<Solution*>);
