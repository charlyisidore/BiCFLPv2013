...
public:
  ...
  /*!
   *	\brief Getter for the demand of this \c Customer.
   *	\return A double as the demand of this \c Customer.
   */
  double getDemand() const;
  /*!
   *	\brief Setter for the demand of this \c Customer.
   *	\param[in] val : A double which represents the value of the demand of this \c Customer.
   */
...
private:
  ...
  double demand_; /*!< Double which represents the demand of this \c Customer */
